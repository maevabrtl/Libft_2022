...
#    Updated: 2023/05/08 21:17:15 by Maya             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_tolower.c ft_toupper.c ft_utoabase.c
OBJS = $(SRCS:.c=.o)
BONUS_SRCS = ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c \
ft_lstfree.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c
